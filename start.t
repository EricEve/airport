...
+ Decoration 'passengers; ; locals americans people'
...
++ newspaper: Thing 'newspaper; narcosia; paper herald'
    ...
    readDesc = '''A quick skim of the paper reveals nothing unusual for this part
        ...
        nation slightly closer to the breadling. The defence minister is
...
lounge: Room 'Pilot\'s Lounge' 'pilot\'s lounge'
    ...
    settee that runs along one wall and the scattering of easy chairs. The on;y
